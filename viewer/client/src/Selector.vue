...
.selector > h2 { flex: 0 1 content; margin: 0 .2rem .4rem; font-size: 1.3rem; font-weight: 500; color: #333; }
...
.selector > div { flex: 1 1 content; overflow: scroll; /* background: #fff; */ }
